...
class _StandbyPageState extends State<StandbyPage> {
  List<Map<String, String>> standbyBusDetails = [
    {
      'Bus Number': 'GHI789',
      'Bus Seats': '30',
      'Bus Route': 'Standby Route 1',
      'Driver Name': 'Sam Wilson',
      'Driver Phone': '321-654-0987',
      'Registration Plate': 'LMN-123',
      'Status': 'Inactive',
    },
    {
      'Bus Number': 'JKL012',
      'Bus Seats': '35',
      'Bus Route': 'Standby Route 2',
      'Driver Name': 'Peter Parker',
      'Driver Phone': '987-654-3210',
      'Registration Plate': 'LMN-456',
      'Status': 'Inactive',
    },
  ];
  ...
  Widget build(BuildContext context) {
    List<Map<String, String>> filteredBusDetails = standbyBusDetails.where((bus) {
                    ...
                    return DataRow(cells: [
                      ...
                      _buildWidgetCell(
                        ElevatedButton(
                          onPressed: () {
                            setState(() {
                              busDetail['Status'] = busDetail['Status'] == 'Inactive'
                                  ? 'Activate'
                                  : 'Inactive';
                            });
                          },
                        ...
                        Row(
                          children: [
                            ...
                            IconButton(
                              ...
                              onPressed: () {
                                setState(() {
                                  standbyBusDetails.removeAt(index);
                                });
                              },
                            ),
                          ],
  ...
  void _showEditDialog(Map<String, String> busDetail) {
    ...
    showDialog(
      ...
      builder: (context) {
        return AlertDialog(
          title: Text('Edit Standby Bus Details'),
          content: SingleChildScrollView(
            child: Column(
              children: [
                TextField(
